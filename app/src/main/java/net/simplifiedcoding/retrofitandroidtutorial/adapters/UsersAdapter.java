...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsersViewHolder holder, int position) {
        ...
        holder.textViewEmailVer.setText(user.getEmail_verified_at());
        holder.textViewCreated.setText((CharSequence) user.getCreated_at());
        holder.textViewUpdated.setText((CharSequence) user.getUpdated_at());
    ...
    class UsersViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewName, textViewEmail, textViewEmailVer,textViewCreated,textViewUpdated,textViewRole;
        ...
        public UsersViewHolder(View itemView) {
            ...
            textViewEmailVer = itemView.findViewById(R.id.textViewEmailVer);
